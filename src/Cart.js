...
//         <div key={el.id}>
//             <img className=" w-full h-full object-center object-cover lg:w-full lg:h-full" 
//                          src={el.image} width={150}/>
//             {el.title}
//             ${el.price}
//         </div>
//     ));
...
//                 <div>{cartItems}</div>
//                 <br/>
//                 <div className="h-24 w-24">{cartItems}</div>
//                 <br/>
//             </div>
//             <br/>
//             <div className="font-bold text-lg">Order Total: ${cartTotal.toFixed(2)}</div>
//         </div>
//     );
...
function validate(order) {
  ...
  if (val) {
    ...
    alert(
      '<i className="bi-cart-check-fill"></i> Please buy again',
      "success"
    );
  }
  return val;
        ...
        <div className="row ">
          <div className="col-3">
            <button
              ...
              id="back-button"
              className="my-4 bg-black hover:bg-slate-400 py-2 px-2 border-white rounded text-white"
            >
              back
            </button>
          ...
          <div className="col-8">
            ...
            <form className="row g-3 text-white" id="checkout-form">
              ...
              <div className="col-12">
                <button
                  type="submit"
                  className="btn btn-success my-4 bg-black text-white border border-white"
                  onClick={(event) => {
                    if (!validate(order)) {
